...
@section('content')
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg w-full max-w-md">
            <h2 class="text-2xl font-semibold mb-6 text-center text-gray-800">Create Staff</h2>
            ...
            <form action="{{ route('create') }}" method="post" class="space-y-5">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700">Picture:</label>
